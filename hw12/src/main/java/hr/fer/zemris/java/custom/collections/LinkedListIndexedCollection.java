...
public class LinkedListIndexedCollection implements List{
	...
	/**
	 * Class that implements the ElementsGetter interface for use on the LinkedListIndexedCollection objects.
	 * @author Mauro Staver
	 */
	private static class ListElementsGetter implements ElementsGetter{
		...
		/**
		 * ListElementsGetter constructor.
		 * Constructs and initializes a new ListElementsGetter object.
	...
	/**
	 * If exists, removes the first occurrence of the specified element from this list.
	 * @param value Element to be removed
	 * @return True if successfully removed, false if list doesn't contain the specified element.
	 */
	@Override
