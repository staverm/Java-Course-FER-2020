...
/**
 * Interface that extends the Collection interface and defines new methods
 * specific to indexed collections.
 * 
 * @author Mauro Staver
 *
 */
public interface List<E> extends Collection<E> {
	 ...
	 * @throws IndexOutOfBoundsException if the position is not in interval [0,
	 *                                   size]
	 */
	 ...
	 * given object or -1 if not found.
	 * 
