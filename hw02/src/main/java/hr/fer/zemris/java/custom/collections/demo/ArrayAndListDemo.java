...
/**
 * Class that demonstrates the behavior and use of ArrayIndexedCollection and LinkedListIndexedCollection classes.
 * @author Mauro Staver
 *
 */
public class ArrayAndListDemo {
	 ...
	 * The method demonstrates the behavior and use of ArrayIndexedCollection and LinkedListIndexedCollection classes.
	...
	public static void main(String[] args) {
		...
		System.out.println(col.get(0)); // writes: "San Francisco"
	}
}
