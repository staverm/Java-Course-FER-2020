...
/**
 * Class that implements an array based collection with dynamic resizing. It
 * supports all basic collection operations.
 * 
 * @author Mauro Staver
 *
 */
public class ArrayIndexedCollection<E> implements List<E> {
	 ...
	 * ArrayIndexedCollection objects.
	 * 
	 * @author Mauro Staver
	 */
	private static class ArrayElementsGetter<E> implements ElementsGetter<E> {
		...
		/**
		 * ArrayElementsGetter constructor. Constructs and initializes a new
		 * ArrayElementsGetter object.
		 * 
		 * @param array Array on which we want to use the ListElementsGetter.
		 */
		public ArrayElementsGetter(ArrayIndexedCollection<E> array) {
			this.array = array;
	...
	/**
	 * Constructor. Creates a new instance of this collection using the given value
	 * for the capacity of the internal array.
	 * 
	...
	public ArrayIndexedCollection(int initialCapacity) throws IllegalArgumentException {
		if (initialCapacity < 1) {
			throw new IllegalArgumentException("The argument for capacity has to be" + "larger than 0");
		}
	...
	/**
	 * Constructor. Creates a new instance of this collection and initializes it
	 * using the given collection's objects. Initial capacity of internal array is
	 * the larger value of given collection's size and initialCapacity.
	 * 
	 * @param other           Collection used to initialize this instance of
	 *                        ArrayIndexedCollection.
	 * @param initialCapacity value for initial capacity for internal array
	 * @throws NullPointerException if other is null
	 */
	public ArrayIndexedCollection(Collection<? extends E> other, int initialCapacity) throws NullPointerException {
		this(Math.max(other.size(), initialCapacity)); // throws exception if other is null
		this.addAll(other);
	}

	/**
	 * Constructor. Creates a new instance of this collection. Initial capacity of
	 * internal array is set to 16.
	 */
	 ...
	 * Constructor. Creates a new instance of this collection and initializes it
	 * using the given collection's objects. Initial capacity of internal array is
	 * the larger value of given collection's size and 16
	 * 
	 ...
	 * @return True if successfully removed, false if collection doesn't contain the
	 *         specified element.
	 */
	@Override
	...
	/**
	 * Doubles the capacity if collection is full. Complexity: amortized O(1)
	 */
	@SuppressWarnings("unchecked")
	private void doubleSizeIfFull() {
		...
		if (size >= originalCapacity) { // reallocate with double size
			...
			E[] tmp = (E[]) new Object[2 * originalCapacity];
	...
	/**
	 * Adds the given object at the end of the collection. Complexity: amortized
	 * O(1)
	 * 
